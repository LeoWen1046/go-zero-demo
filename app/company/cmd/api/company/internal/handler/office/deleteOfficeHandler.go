...
func DeleteOfficeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OfficeDeleteRequest
		if err := httpx.Parse(r, &req); err != nil {
			result.ParamErrorResult(r, w, err)
			return
		}

		l := office.NewDeleteOfficeLogic(r.Context(), svcCtx)
		resp, err := l.DeleteOffice(&req)
